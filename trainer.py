...
class Trainer:
    ...
    def _train(self):
        ...
        for i, sample in batch_iter:
            input_x = sample['image'].to(self.device)
            target_y = sample['mask'].to(self.device)  # send to device (GPU or CPU)
    ...
    def _validate(self):
        ...
        for i, sample in batch_iter:
            ...
            target = sample['mask'].to(self.device)  # send to device (GPU or CPU)
